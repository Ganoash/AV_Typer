...
class MyTestCase(unittest.TestCase):
    def setUp(self) -> None:
        self.weekend = File(path.join(path.dirname(__file__), "../../../test_data/Weekendsheet 21(1).xlsx"), SheetType.WEEKEND)
        self.activiteit = File(path.join(path.dirname(__file__), "../../../test_data/Activiteitensheet 21.xlsx"),
                            SheetType.ACTIVITEIT)
        self.borrel = File(path.join(path.dirname(__file__), "../../../test_data/Borrelsheet 21(3).xlsx"),
                            SheetType.BORREL)
    ...
    def test_collect_overzicht(self):
        ...
        headers = ["Datum", "Deb_NR", "GBK", "Doc/fac", "Omschrijving", "Debit", "Credit", "Saldo"]
    ...
    def test_collect_debiteuren(self):
        ...
        debiteuren_w = ["9171087D", "9181131D", "9191150D", "915909D", "912627D", "911567D","914793D", "9181144D"]
        debiteuren_b = ["916998D", "9181128D", "9191211D", "9211283D", "9211259D", "913672D", "914775D", "9191211D",
                        "913674D", "915893D", "9191188D", "9211252D", "9211275D", "9161005D", "9201228D"]
        debiteuren_a = ["9181113D", "9211276D", "9191188D", "9201228D", "9181144D", "9211275D", "9171037D",
                         "9181128D", "9191211D", "915901D", "916997D", "9181131D", "9181132D"]
    ...
    def check(self, frame: pd.DataFrame, headers: list, length: int, GBK: list, debiteuren: list = None):
        print(frame)
